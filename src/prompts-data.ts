...
export function buildHighlightsPrompt(reportContents: Record<string, string>, lang: Lang = "zh"): string {
...
For each report, extract 2-3 of the most noteworthy highlights — the kind that would make a reader want to click through. Each highlight should be a single short sentence (under 60 characters).
...
- 2-3 highlights per report, each under 60 characters
...
为每份报告提取 2-3 条最值得关注的亮点——能让读者产生点击欲望的那种。每条亮点用一句简短的话（不超过 30 个字）。
